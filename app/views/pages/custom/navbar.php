<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbarlight text-white">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-SupportedContent"
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <form action="" class="tipe-form form form-inline my-2 my-lg-0">
            ...
            <div class="dropdown">
                <span class="btn-radio dropdown-toggle" id="actionPerfil" data-toggle="dropdown" aria-haspopup="true" style="color:black;"
                    aria-expanded="false">
                    <img src="<?php echo URL_PROJECT . '/' . $datos['perfil']->fotoPerfil ?>" alt="foto-perfil"
                        style="width: 20px;" class="img-perfil" />
